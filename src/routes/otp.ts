// Dead code: OTP verification was removed from the registration flow, so
// this route is no longer mounted in index.ts. Kept commented out in case
// it's reintroduced later.
//
